            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        'url'=>'Yii::app()->createUrl("rol/default/quit", array("item"=>$data->id))',//reemplazar module por el modulo que estan trabajando
                    ),
                    'editar' => array
                    (
                        'label'=>'Edit Element',
                        ...
                        'url'=>'Yii::app()->createUrl("rol/default/index", array("item"=>$data->id))',//reemplazar module por el modulo que estan trabajando
                    ),
