...
/**
 * This is the model class for table "headerquote".
 *
 * The followings are the available columns in table 'headerquote':
 * @property integer $ID
 ...
 */
class Headerquote extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			//array('customer, city, people, children, package, nationality, paymentplan, date, observation, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'required'),
			array('people, children, paymentplan', 'numerical', 'integerOnly'=>true),
			array('customer, city, package, nationality, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, customer, city, people, children, package, nationality, paymentplan, date, observation, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('paymentplan',$this->paymentplan);
	 ...
	 * @return Headerquote the static model class
	 */
