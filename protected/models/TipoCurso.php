 ...
 *
 * The followings are the available columns in table 'tipo_curso':
 * @property integer $ID
 ...
 */
class TipoCurso extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			//array('nombre, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'required'),
			array('nombre, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, nombre, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TipoCurso the static model class
	 */
