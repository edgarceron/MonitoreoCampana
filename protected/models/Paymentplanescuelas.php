...
/**
 * This is the model class for table "paymentplanescuelas".
 *
 * The followings are the available columns in table 'paymentplanescuelas':
 * @property integer $ID
 ...
 */
class Paymentplanescuelas extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			//array('id_escuela, cuotas, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'required'),
			array('id_escuela, cuotas', 'numerical', 'integerOnly'=>true),
			array('dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, id_escuela, cuotas, dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8, dat9, dat10', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Paymentplanescuelas the static model class
	 */
