 ...
 *
 * The followings are the available columns in table 'nacionalidades':
 * @property integer $ID
...
class Nacionalidades extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('nombre, dat1, dat2', 'required'),
			array('nombre, dat1, dat2', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, nombre, dat1, dat2', 'safe', 'on'=>'search'),
		);
	}
