 ...
 * @property string $fecha_registrada
 *
...
class Calls extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('fecha_llamada, start_time, end_time, datetime_entry_queue, date_init, date_end, time_init, time_end, datetime_originate, fecha_registrada', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_campaign, phone, status, uniqueid, fecha_llamada, start_time, end_time, retries, duration, id_agent, transfer, datetime_entry_queue, duration_wait, dnc, date_init, date_end, time_init, time_end, agent, failure_cause, failure_cause_txt, datetime_originate, trunk, scheduled, fecha_registrada', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('fecha_registrada',$this->fecha_registrada,true);
